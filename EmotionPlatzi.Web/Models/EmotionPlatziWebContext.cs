...
namespace EmotionPlatzi.Web.Models
{
    public class EmotionPlatziWebContext : DbContext
    {
        ...
        {
            //aqui se crea o recrea la estrategia de base de datos
            //por que si hay cambios en el modelo pueden haber varios escenarios
            //le descimos que borre y recree el modelo de datos
            Database.SetInitializer<EmotionPlatziWebContext>(
                //cada que se modifique un modelo, se recrea la base de datos, esto
                //nunca se debe hacer una vez que tenemos la primera version en producción
